...
export default function Header() {
  return (
            <div className="sticky top-0 z-10 z-stickybg-[#2699fb] p-4">
             <div className='max-w-[1240px] flex z-0 items-center py-[12px] shadow bg-white justify-between mx-auto  border border-bg-black rounded-full p-10'>
